  ...
  return (
    <section className="images mt-[64px]">
      <div className="firstImage w-full h-[550px] relative">
        ...
        <div className="positionCenter absolute top-1/2 left-1/2 bg-white w-[614px] h-[300px]">
          <p className="fontCera pt-[60px] text-[20px] text-center text-[#00a0df] font-bold">Celebrating 10 years of happy customers</p>
          <p className="fontChronicle text-[28px] text-center text-[#002c9b] mt-[28px] leading-normal">
            We changed from HelloFresh to Blue Apron <br />
      ...
      <div className="secondImage relative w-2/3 h-[300px] m-auto mt-16 fontCera">
        ...
        <div className="positionCenter absolute top-1/2 left-1/2 bg-white w-[400px] h-[220px]">
