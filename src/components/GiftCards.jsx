    ...
    <main>
      <section className="mt-[60px] border-t-[1px] border-[#ECEEF2] bg-[#fafbfc]">
        <div className="block m-auto w-[62%] relative">
          ...
          <h1 className="absolute top-1/2 left-1/2 positionCenter fontCera text-[70px] leading-[72px] w-[492px] text-center text-[#0f346c] font-semibold">
            Meal Kit <br /> Delivery Gifts <br /> & Gift Cards
          </h1>
        </div>
