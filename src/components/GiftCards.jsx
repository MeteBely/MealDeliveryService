        ...
        <section className='mt-[60px] border-t-[1px] border-[#ECEEF2] bg-[#fafbfc]'>
            ...
            <div className='bottomItems w-[63%] m-auto block mt-8'>
                ...
                <div className='text-[#0f346c] text-[14px] font-semibold text-center'>
                    <div className='rounded-[5px] inline-block bg-white m-[10px] w-[250px] h-[60px] pt-[20px]'><Link to='/pages/corporate-sales' className='cursor-pointer hover:underline' href="">Need more than 50 gift cards?</Link></div>
