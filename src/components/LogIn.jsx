    ...
    <section className='bg-[#FAFBFC] mt-[62px] border-t-[1px] border-[#ECEEF2] pb-8'>
       ...
       {({isSubmitting}) => (
         <Form className='mb-2'>
            ...
            <div className='flex flex-row justify-between w-full text-[#b9b9c5]'><div><input className='align-middle mr-2 cursor-pointer' type="checkbox" name="" id="rememberAcc" /><label htmlFor='rememberAcc' className='text-[14px] fontCera cursor-pointer'>Remember Me?</label></div><Link to='/users/password/new' href="" className='text-[#0f346c] hover:underline text-[14px] fontCera'>Forgot Password?</Link></div>
     ...
     <div className='text-white fontChronicle text-[20px] mt-2'>
        <button  className='bg-black w-full h-[47.88px] relative mb-3 rounded-[5px]'><FaApple fontSize="1em" className='absolute left-[58px] top-3.5'/>Sign in with Apple</button>
        <button className='bg-blue-500 w-full h-[47.88px] relative rounded-[5px]'><FaFacebook fontSize="1em" className='absolute left-[46px] top-3.5' />Sign in with Facebook</button>
     </div>
     <div className='text-center text-[14px] fontCera text-[#6a6d75] mt-6'>Don't have an account? <Link to='/users/sign_up' href="" className='text-[#0f346c] underline'>Sign Up</Link></div>
