  ...
  return (
    ...
    <Dialog open={dialogOpen}  sx={{backdropFilter: "blur(1px) sepia(1%)"}} PaperProps={{ sx: {borderRadius: "18px" }}} onClose={() => setDialogOpen(false)} className='rounded-[50px]'>
      <div className='px-8 py-6 relative'>
        ...
        <DialogContent>
            <DialogContentText><p className='text-[#6a6d75] leading-[155%] mb-4'>Free standard shipping (estimated 5-7 business days) with orders over $50! <br /><br />Blue Apron subscriptions, Blue Apron gift boxes, taxes and prior purchases do not qualify toward the minimum purchase requirement and the offer cannot be applied to such items. Eligible customers must select this option during checkout in order to receive free shipping. If you choose another shipping option, additional charges will apply. <br /><br />Shipping is only available in the 48 contiguous United States. We do not ship to PO Box addresses.</p></DialogContentText>
            <DialogActions><a className='absolute top-[20px] right-[25px] cursor-pointer' onClick={() => setDialogOpen(false)}><AiFillCloseCircle size={40} color='grey' /></a></DialogActions>
        </DialogContent>
        </div>
       </Dialog>
  </header>
