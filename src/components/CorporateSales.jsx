    ...
    <main>
      <section>
        <div className="m-auto block mt-[80px] text-center fontCera">
          <h2 className="mb-4 text-[24px] text-[#303236]">
            Reward your employees and clients with the gift of home cooking!
          </h2>
          <span className="text-[#002684] text-[18px] ">
            Blue Apron Corporate Gifts can be personalized by each individual.
          </span>
        </div>
        <Formik
          initialValues={{
          ...
          {({ isSubmitting }) => (
            <Form className="mt-[60px] w-[62%] m-auto border border-[#d3d5db] flex flex-row gap-[100px] p-[20px]">
              <div className="firstFormCol flex flex-col justify-start w-full">
                <div>
                  <h3 className="text-[20px] fontCera text-[#303236] mb-[14px]">
              ...
              <div className="secondFormCol w-full">
                ...
                <div>
                  <button
                    ...
                    className="mt-[5px] text-[18px] h-[60px] px-[45px] fontCera tracking-widest bg-[#235091] hover:bg-[#0F346C] text-[#fff]"
                  >
                    SEND ORDER REQUEST
                  </button>
                  <p className="text-[12px] italic mt-[5px] font-light text-[#6a6d75] ">
                    A representative will follow up for billing with a separate
                    invoice.
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-row w-[62%] m-auto justify-between gap-16 mt-12 px-[20px]">
          <div className="text text-[#303236] w-[48%]">
            <div className="mb-[40px]">
              <h3 className="mb-[5px] text-[17px] fontChronicle">
                No Commitment
              </h3>
              <p className="text-[15px] fontCera font-thin">
            ...
            <div className="mb-[40px]">
              ...
              <p className="text-[15px] fontCera font-thin">
                Tell us your dietary preferences and we’ll personalize the menus
                you receive.
              </p>
            </div>
            <div>
              ...
              <p className="text-[15px] fontCera font-thin">
                Ingredients are carefully packaged in a refrigerated box so food
                stays fresh even if you’re not home when we deliver.
              </p>
            </div>
          </div>
          <div className="image mb-[40px]">
            <img
              src="https://media.blueapron.com/assets/gifts/gift-intro-bg-mothers-day-e0ad80ef0ea41bc82c69cc1c0d5234e70f938c691fcf49241da54b079f26c0d2.jpg"
              alt=""
            />
          </div>
        </div>
