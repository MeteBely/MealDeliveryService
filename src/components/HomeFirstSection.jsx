  ...
  return (
    <section>
      <div className="relative">
        ...
        <h1 className="fontChronicle absolute top-2/4 left-10 text-5xl text-blue-700">
          The meal kit that
          <br />
          puts quality first
        </h1>
      ...
      <div className="rating-section flex flex-col items-center justify-center bg-coolGray-200 h-[250px] gap-2 fontCera">
        <span className="text-[32px] font-bold">
          Our customers think we're <span className="text-[32px] text-[#00a0df]">EXCELLENT</span>
        </span>
        <div>
