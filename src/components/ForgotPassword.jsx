    ...
    <section className='bg-[#FAFBFC] mt-[62px] border-t-[1px] border-[#ECEEF2] pb-8'>
       ...
       {({isSubmitting}) => (
         <Form className=''>
            ...
            <button type='submit' disabled={isSubmitting} className='text-[14px] w-full h-[47.88px] fontCera tracking-widest bg-[#235091] hover:bg-[#0F346C] text-[#fff] fontCera uppercase'>Send Reset Instructions</button>
         </Form>
       )}
     </Formik>
     <div className='text-center text-[14px] fontCera text-[#0d2a54] mt-6'><Link to='/users/sign_in' className='underline' href="">Log In</Link><div className='inline-block w-4'>|</div><Link to='/users/sign_up' href="" className='underline'>Sign Up</Link></div>
